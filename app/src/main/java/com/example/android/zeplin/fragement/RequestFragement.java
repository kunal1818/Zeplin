...
public class RequestFragement extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        ...
        if (flag == 0) {
            ModelClass modelClass = new ModelClass(R.drawable.paris, "John", "Lorem ipsum is just the dummy", "text used in print typeseting");
            modelClassArrayList.add(modelClass);

            ModelClass modelClass1 = new ModelClass(R.drawable.paris, "John", "Lorem ipsum is just the dummy", "text used in print typeseting");
            modelClassArrayList.add(modelClass1);

            ModelClass modelClass2 = new ModelClass(R.drawable.paris, "John", "Lorem ipsum is just the dummy", "text used in print typeseting");
